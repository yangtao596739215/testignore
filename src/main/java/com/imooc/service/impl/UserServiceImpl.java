...
public class UserServiceImpl implements UserService {
	...
	public Users queryUserForLogin(String username, String pwd) {
		...
		//创建一些条件进行查询,不需要写sql   tk.mybatis 包下面的
	...
	public Users saveUser(Users user) {
		...
		// 为每个用户生成一个唯一的二维码
		String qrCodePath = "F:\\muxin" + userId + "qrcode.png";
		...
		String qrCodeUrl = "";
		try {
			minioUtils.uploadFile(qrCodeFile,"muxin",userId+"--userqrcode.png");
			qrCodeUrl = minioUtils.getObjectURL("muxin", userId+"--userqrcode.png");
			log.info(qrCodeUrl);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void sendFriendRequest(String myUserId, String friendUsername) {
		...
		frc.andEqualTo("acceptUserId", friend.getUserId());
